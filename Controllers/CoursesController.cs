...
namespace whetstone_MIS4200_MVC_P1.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            ViewBag.instructorID = new SelectList(db.Instructors, "instructorID", "instructorsFirstName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CourseID,courseDescription,courseTime,instructorID")] Course course)
        {
            ...
            ViewBag.instructorID = new SelectList(db.Instructors, "instructorID", "instructorsFirstName", course.instructorID);
            return View(course);
        }
