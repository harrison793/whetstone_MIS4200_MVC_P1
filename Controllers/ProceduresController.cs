...
namespace whetstone_MIS4200_MVC_P1.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "procedureID,description,unitCost")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "procedureID,description,unitCost")] Procedure procedure)
        {
            if (ModelState.IsValid)
            {
